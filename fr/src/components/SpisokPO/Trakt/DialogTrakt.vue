<template>
  <v-dialog v-model="show" max-width="700px">
    <v-card>
      <v-card-title>
        <span class="headline">Создать тракт</span>
      </v-card-title>
      <v-card-text>
...
export default {
  ...
  methods: {
    ...
    save() {
      ...
      this.$http
        .post(
          `${this.url.baseUrl}/apps/opu/objects/trakt/object-create/${this.idLPForTrakt[0].id}/`,
          {
